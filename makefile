...
TARGETS= main test
OBJECTS= server.o client.o packets.o session.o lobby.o ServerRecv.o receiver.o clientReceiver.o clientSender.o controller.o serverSender.o view.o model.o
